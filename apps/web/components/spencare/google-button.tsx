 ...
 *
 * Solid `variant="default"` (primary purple fill) with a white Google
 * mark -- matches the canonical Login/Signup screens (Web Screen/
 * Login.pdf, Signup.pdf), which both show a solid-purple "Continue with
 * Google" pill, not an outline button (Phase 19 design-system audit
 * finding; corrected here, the only styling change this pass makes).
 */
