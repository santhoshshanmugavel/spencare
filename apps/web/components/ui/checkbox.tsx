...
/**
 * Phase 26 -- built from the already-installed `radix-ui` meta-package
 * (no new dependency), matching select.tsx/radio-group.tsx's exact class
 * conventions (radius, focus ring, aria-invalid, disabled) so it reads as
 * the same design system rather than a new visual language.
 */
function Checkbox({
  className,
  ...props
